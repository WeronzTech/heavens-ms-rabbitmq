...
import temporaryRoomRoutes from "./routes/property/temporaryRoom.routes.js";
...
app.use(
  cors({
    origin: [
      ...
      "http://172.20.10.8:8082",
      "http://192.168.1.77:8082",
      "http://192.168.1.86:8082",
      "http://localhost:8082",
      "http://localhost:8083",
...
app.use("/api/v2/property/temporary-room", temporaryRoomRoutes);
