...
//   try {
//     const { merchantId, merchantData, files = {} } = data;

//     console.log("Update Merchant - Received data:", { merchantId, merchantData, files });

//     // ✅ FIXED: Parse merchantData if it's a string (from FormData)
//     let parsedMerchantData = merchantData;
//     if (typeof merchantData === 'string') {
//       try {
//         parsedMerchantData = JSON.parse(merchantData);
//         console.log("Parsed merchantData:", parsedMerchantData);
//       } catch (parseError) {
//         console.error("Error parsing merchantData:", parseError);
//         return { status: 400, message: "Invalid merchantData format" };
//       }
//     }
...
//     // Handle Image Uploads for merchantDetail
//     const imageUpdates = await handleMerchantImages(files, merchant.merchantDetail);

//     // Update merchantDetail if provided
//     if (parsedMerchantData.merchantDetail) {
//       const updatedDetail = {
//         ...merchant.merchantDetail.toObject(),
//       };

//       Object.keys(parsedMerchantData.merchantDetail).forEach(key => {
//         if (parsedMerchantData.merchantDetail[key] !== null && parsedMerchantData.merchantDetail[key] !== undefined && parsedMerchantData.merchantDetail[key] !== "") {
//           updatedDetail[key] = parsedMerchantData.merchantDetail[key];
//         }
//       });
...
//     // ✅ FIXED: Update bankDetail if provided
//     if (parsedMerchantData.bankDetail) {
//       console.log("Updating bank details:", parsedMerchantData.bankDetail);
      
//       // Initialize bankDetail as a proper object if it doesn't exist
//       if (!merchant.bankDetail || typeof merchant.bankDetail !== 'object') {
//         merchant.bankDetail = {};
//       }

//       // Update each field in bankDetail
//       Object.keys(parsedMerchantData.bankDetail).forEach(key => {
//         const value = parsedMerchantData.bankDetail[key];
//         if (value !== null && value !== undefined && value !== "") {
//           merchant.bankDetail[key] = value;
//         }
//       });

//       console.log("Updated bankDetail:", merchant.bankDetail);
      
//       // ✅ IMPORTANT: Mark bankDetail as modified for Mongoose to save it
//       merchant.markModified('bankDetail');
//     }

//     // Update availability if provided
//     if (parsedMerchantData.availability) {
//       console.log("Updating availability:", parsedMerchantData.availability);
//       merchant.availability = parsedMerchantData.availability;
//       merchant.markModified('availability');
//     }

//     // ✅ Save the merchant document
//     await merchant.save();
//     console.log("Merchant saved successfully with bankDetail:", data);
